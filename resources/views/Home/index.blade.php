        ...
        <div class="hero-container">
            ...
            <div class="hero-grid-cards">
                <div class="stat-card orange-card">
                    ...
                    <p class="count">847 <span>laporan</span></p>
                </div>
                <div class="stat-card blue-card active-pill">
                    <div class="card-icon"><i class="fa-solid fa-cloud-showers-heavy"></i></div>
                    <h3>Banjir & Genangan</h3>
                    <p class="count">312 <span>aktif</span></p>
                </div>
                <div class="stat-card yellow-card">
                    <div class="card-icon"><i class="fa-regular fa-lightbulb"></i></div>
                    <h3>PJU Mati</h3>
                    <p class="count">193 <span>laporan</span></p>
                </div>
                <div class="stat-card gray-card">
                    <div class="card-icon"><i class="fa-solid fa-bridge"></i></div>
                    <h3>Jembatan Rusak</h3>
                    <p class="count">58 <span>laporan</span></p>
                </div>
                <div class="stat-card green-card">
                    <div class="card-icon"><i class="fa-regular fa-trash-can"></i></div>
                    <h3>Sampah Menumpuk</h3>
                    <p class="count">428 <span>laporan</span></p>
                </div>
                <div class="stat-card red-card active-pill">
                    <div class="card-icon"><i class="fa-solid fa-house-chimney-crack"></i></div>
                    <h3>Longsor Ringan</h3>
                    <p class="count">29 <span>aktif</span></p>
                </div>
            </div>
        </div>
